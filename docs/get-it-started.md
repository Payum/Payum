...
_**Note**: If you are working with [symfony2](https://github.com/Payum/PayumBundle/blob/master/Resources/doc/index.md) framework check the payum bundle documentation instead._
