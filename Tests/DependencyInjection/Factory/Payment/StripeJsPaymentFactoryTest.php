...
class StripeJsPaymentFactoryTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @test
     */
    ...
    {
        $rc = new \ReflectionClass('Payum\Bundle\PayumBundle\DependencyInjection\Factory\Gateway\StripeJsPaymentFactory');
    ...
    public function shouldAllowCreatePaymentAndReturnItsId()
    {
        ...
        $this->assertEquals('payum.stripe_js.aPaymentName.payment', $paymentId);
