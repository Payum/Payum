...
{   
    ...
    public function persistPaymentDetails()
    {
        //@testo:source
        //@testo:uncomment:use Payum\Payment;
        //@testo:uncomment:use Payum\Core\Storage\FilesystemStorage;
        //@testo:uncomment:use Payum\Core\Extension\StorageExtension;
    ...
    public function loggerExtension()
    {
        //@testo:start
        //@testo:source
        //@testo:uncomment:use Payum\Core\Bridge\Psr\Log\LoggerExtension;
    ...
    public function logExecutedActions()
    {
        ...
        //@testo:start
        //@testo:source
        //@testo:uncomment:use Payum\Core\Bridge\Psr\Log\LogExecutedActionsExtension;
        //@testo:uncomment:use Payum\Examples\Action\CaptureAction;
        //@testo:uncomment:use Payum\Payment;
        //@testo:uncomment:use Payum\Core\Request\CaptureRequest;
