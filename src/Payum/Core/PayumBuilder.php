...
use Payum\Paypal\ExpressCheckout\NvpViaToken\PaypalExpressCheckoutViaTokenGatewayFactory;
...
class PayumBuilder
{
    ...
    protected function buildGatewayFactories(GatewayFactoryInterface $coreGatewayFactory)
    {
        $map = [
            ...
            'paypal_express_checkout_via_token' => PaypalExpressCheckoutViaTokenGatewayFactory::class,
