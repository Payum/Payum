...
class PayumBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function shouldBuildDefaultPayum()
    {
        ...
        $this->assertArrayHasKey('paypal_express_checkout_permission', $factories);
        $this->assertInstanceOf(PaypalExpressCheckoutPermissionGatewayFactory::class, $factories['paypal_express_checkout_permission']);
