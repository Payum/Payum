...
class Api
{
     ...
     */
    public function __construct(array $options, GuzzleClient $client )
    {
        ...
        $this->client = $client ?: new \Payum\Core\Bridge\Guzzle\Client(new GuzzleHttpClient);
    }
    ...
    protected function doRequest($method, $fields)
    {
        ...
        $response = new Psr7\Response($this->client->send($request));
        $result = array();
