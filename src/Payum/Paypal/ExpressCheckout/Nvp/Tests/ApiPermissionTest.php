...
class ApiPermissionTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @test
     */
    ...
    {
        new ApiPermission(array(), $this->createHttpClientMock(), $this->createHttpMessageFactory());
    }
    ...
    public function shouldAddAuthorizeFieldsOnSetExpressCheckoutCall()
    {
        $api = new ApiPermission(array(
            ...
            'token' => 'the_token',
            'tokenSecret' => 'the_tokenSecret',
            'third_party_subject' => 'the_third_party_subject',
            'sandbox' => true,
            'return_url' => 'optionReturnUrl',
            'cancel_url' => 'optionCancelUrl',
        ), $this->createSuccessHttpClientStub(), $this->createHttpMessageFactory());
        ...
        $this->assertEquals('the_third_party_subject', $result['SUBJECT']);
    }
    ...
    public function shouldAddVersionOnSetExpressCheckoutCall()
    {
        ...
        $this->assertEquals(ApiPermission::VERSION, $result['VERSION']);
    }
