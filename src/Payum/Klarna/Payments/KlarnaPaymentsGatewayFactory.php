<?php
namespace Payum\Klarna\Payments;
...
class KlarnaPaymentsGatewayFactory extends GatewayFactory
{
    /**
     * {@inheritDoc}
     */
    protected function populateConfig(ArrayObject $config)
    {
        ...
        $config->defaults(array(
            'payum.factory_name' => 'klarna_payments',
            'payum.factory_title' => 'Klarna Payments',
            'payum.template.authorize' => '@PayumKlarnaPayment/Action/capture.html.twig',
            'sandbox' => true,
        ));
        ...
        $config['payum.paths'] = array_replace([
            'PayumKlarnaPayments' => __DIR__.'/Resources/views',
        ], $config['payum.paths'] ?: []);
    }
}
