...
_**Note**: Where payum/xxx is a payum package, for example it could be payum/paypal-express-checkout-nvp. Look at [supported payments](simple_purchase_examples.md) to find out what you can use._
