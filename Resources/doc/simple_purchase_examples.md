# Simple purchase examples

* [Paypal express checkout](simple_purchase_examples/paypal_express_checkout.md).
* [Paypal pro checkout](simple_purchase_examples/paypal_pro_checkout.md).
* [Payex](simple_purchase_examples/payex.md).
