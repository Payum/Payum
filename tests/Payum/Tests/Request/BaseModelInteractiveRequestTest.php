...
class BaseModelInteractiveRequestTest extends \PHPUnit_Framework_TestCase 
{
    ...
    {
        $this->getMockForAbstractClass('Payum\Request\BaseModelInteractiveRequest', array($phpType)); 
    }
    ...
    {
        $request = $this->getMockForAbstractClass('Payum\Request\BaseModelInteractiveRequest', array(123321));
    ...
    {
        $request = $this->getMockForAbstractClass('Payum\Request\BaseModelInteractiveRequest', array($phpType));
    ...
    public function shouldConvertArrayToArrayObjectInConstructor()
    {
        ...
        $request = $this->getMockForAbstractClass('Payum\Request\BaseModelInteractiveRequest', array($model));
